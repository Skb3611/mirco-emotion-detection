...
1. **Data Extraction:** The raw data (provided as a CSV of pixel strings) is converted into actual image files using [dataset\_prepare.py](file:///c%3A/Users/Asus/Desktop/project-hub-projects/Emotion-detection/src/dataset_prepare.py).
...
3. **Face Detection:** The [haarcascade\_frontalface\_default.xml](file:///c%3A/Users/Asus/Desktop/project-hub-projects/Emotion-detection/src/haarcascade_frontalface_default.xml) scans the image to return coordinates `(x, y, w, h)` for all detected faces.
